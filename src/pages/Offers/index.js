    ...
    return (
        width <= 450 ?
            <div>
                ...
                <div style={myStyle}>
                    <div style={{ position: 'absolute', height: tab === 3 ? '50vh' : '50vh', width: '95vw', backgroundColor: 'white', bottom: '0px', borderTopLeftRadius: '25px', borderTopRightRadius: '25px', padding: '10px 10px', }}>
...
const Heading = ({ tab, setTab }) => {
    return (
        <div style={{ width: '100%', alignItems: 'center', display: 'flex', justifyContent: 'center', height: "30px", }}>
            ...
            <p onClick={() => setTab(1)} style={{ backgroundColor: tab === 1 ? 'black' : '', width: '30px', padding: '5px 13px', fontSize: '10px', margin: 10, border: '1px solid black', borderRadius: 5, textAlign: 'center', color: tab === 1 ? 'white' : 'black' }}>Offer</p>

            <p onClick={() => setTab(2)} style={{ backgroundColor: tab === 2 ? 'black' : '', width: '30px', padding: '5px 13px', fontSize: '10px', margin: 10, border: '1px solid black', borderRadius: 5, textAlign: 'center', color: tab === 2 ? 'white' : 'black' }}>Detail</p>

            <p onClick={() => setTab(3)} style={{ backgroundColor: tab === 3 ? 'black' : '', width: '30px', padding: '5px 13px', fontSize: '10px', margin: 10, border: '1px solid black', borderRadius: 5, textAlign: 'center', color: tab === 3 ? 'white' : 'black' }}>Reviews</p>
        </div>
    )
}
